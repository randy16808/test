...
`timescale 1 ns / 1 ps
	...
	// WVALID logic, similar to the axi_awvalid always block above
	  ...
	  begin
	    ...
	    else if (((write_index == C_M_AXI_BURST_LEN-2 && C_M_AXI_BURST_LEN >= 2) && wnext) || (C_M_AXI_BURST_LEN == 1 ) || w_length == 2)
	      begin
	        axi_wlast <= 1'b1;
	      end
	 ...
	 count to reduce decode logic */
	  ...
	  begin
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1 || start_single_burst_write == 1'b1)
	        write_index <= 0;
	    else if (wnext && (write_index != C_M_AXI_BURST_LEN-1) && w_length != 1)
	  ...
	  begin
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1)
	        w_length <= len_copy/4;
	    else if (wnext && (write_index != C_M_AXI_BURST_LEN-1) && w_length == 0)
	        w_length <= w_length - 1;
	    else
	        w_length <= w_length;
	  end
	...
	// terminal count to reduce decode logic
	  ...
	  begin
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1 || start_single_burst_read)
	        read_index <= 0;
	    else if (rnext && (read_index != C_M_AXI_BURST_LEN-1) && r_length != 1)
	 ...
	 */
	  ...
	  begin
	    ...
	    // when M_AXI_RVALID is asserted by slave
	      ...
	      begin
	         if (M_AXI_RLAST && axi_rready && (r_length==0))
	          begin
	            axi_rready <= 1'b0;
	          end
	         else
